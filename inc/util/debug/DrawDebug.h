...
inline bool CheckEntityClicked(float pX, float pY, entt::entity& outEntity, entt::registry& reg)
{
...
inline void DrawSelectedEntityWindow(entt::registry& reg)
{
    ...
    {
        ImVec2 pos = ImGui::GetWindowPos();
        DEBUG_UI_VALUES.entityWindowArea = {pos.x, pos.y, ImGui::GetWindowWidth(), ImGui::GetWindowHeight()};

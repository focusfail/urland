...
void Texture2DAtlas::DrawSprite(int index, float x, float y, Color tint, float scale) const
{
    ...
    DrawTexturePro(m_texture, source, dest, Vector2Zero(), 0.0f, tint);
}

int Texture2DAtlas::GetTileSize() const { return m_tilesize; }